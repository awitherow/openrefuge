<template>
  <div id="involvement" class="container">
    <div class="involvement-item">
      ...
      <ul>
        <li>
          <a target="_blank" href="https://savagedconscience.wordpress.com/">Savaged Conscience</a>, reflections on the Refugee Crisis and its impact on a savaged conscience.</li>
        <li>
          <a target="_blank" href="https://medium.com/openrefuge/hope-for-the-children-of-war-e8a487308248">Hope for the Children of War</a>, another account of the side effects of greed for oil.</li>
        <li>
          <a target="_blank" href="https://medium.com/@TulsiGabbard/the-syrian-people-desperately-want-peace-e308f1777a34#.hg4v7j3ck">The Syrian People Desparately Want Peace</a>, House of Representatives Tulsi Gabbard reflects on her visit to Syria.</li>
      </ul>
    </div>
    <div class="involvement-item">
    ...
    <div class="involvement-item">
      ...
      <ul>
        ...
        <li>
          <a target="_blank" href="https://www.facebook.com/OpenRefuge/">Facebook</a>
        </li>
        <li>
